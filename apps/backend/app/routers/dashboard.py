...
def get_dashboard_summary(
    ...
    """Get comprehensive dashboard summary with KPIs, alerts, and trend data"""
    try:
        ...
        logger.info(f"Dashboard summary generated: {len(alerts)} alerts, {pending_recs} pending recommendations")
